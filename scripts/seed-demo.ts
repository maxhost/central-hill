...
function guestData() {
  // Mirrors drizzle/0012_guest_page_db_wiring.sql — the approved `mock/guest.html` copy.
  // Keep the two in sync: the migration fixes existing databases, this seeds fresh ones.
  const BUILDINGS = `${SITE}/en/buildings`;
  return {
    hero: {
      video_media_id: "",
      ...
      cta: { label: "Browse Our Apartments", url: BUILDINGS },
    },
    welcome: {
    ...
    why: {
      ...
      benefits: [
        ic("Get the Best Prices", "You won't find our apartments cheaper anywhere else — enjoy an average saving of €213 per reservation versus Airbnb, Booking and other platforms.", "percentage-circle"),
        ic("Early Check-In", "Enter the apartment sooner than everyone else and start your trip the moment you arrive. (Pending availability.)", "key"),
        ic("Early Luggage Drop", "Arriving before check-in time? We can let you drop your luggage at the apartment early, hands-free.", "suitcase"),
        ic("Special Discounts", "Enjoy exclusive discounts on services and activities booked with us during your stay.", "gift"),
      ],
      cta: { label: "Browse Our Apartments", url: BUILDINGS, note: "View the full portfolio of available apartments across Portugal." },
    },
    portfolio: {
    ...
    services_teaser: {
      ...
      items: [
        ic("Private Transfers", "Seamless airport and city transfers, ready the moment you land.", "car"),
        ic("Day Tours", "Guided escapes to Portugal's most iconic sights and hidden corners.", "binocular"),
        ic("Boat Trips", "See the coastline and the Tagus from the water on a private cruise.", "sea-waves"),
        ic("Surf Experience", "Catch your first wave with expert local instructors on Atlantic beaches.", "swimming"),
        ic("Chef at Home", "A private chef cooks Portuguese flavours right in your apartment.", "pizza-slice"),
        ic("Luggage Storage", "Drop your bags and explore freely before check-in or after checkout.", "suitcase"),
      ],
      cta: { label: "Explore All Services", url: `${SITE}/en/services`, note: "See details, pricing, and availability." },
    },
    activities_teaser: {
      eyebrow: "What to Do",
      ...
      items: [
        ic("Explore Historic Districts", "Wander cobblestone streets and timeless neighbourhoods full of character.", "bank"),
        ic("Visit UNESCO World Heritage Sites", "From Sintra's palaces to centuries-old monuments and town centres.", "medal"),
        ic("Taste Portuguese Food & Wine", "Pastéis de nata, fresh seafood, and world-class wine regions await.", "pizza-slice"),
        ic("Relax on Stunning Beaches", "Golden sands and dramatic Atlantic coastline, never far away.", "sea-waves"),
        ic("Experience Music & Festivals", "Fado nights, summer festivals, and a year-round cultural calendar.", "music-double-note"),
        ic("Day Trips & Hidden Gems", "Medieval villages and lesser-known spots just beyond the city.", "map"),
      ],
      cta: { label: "Discover More", url: `${SITE}/en/guides`, note: "" },
    },
    dual_cta: {
      guest: {
        eyebrow: "Guests",
      ...
      owner: {
        ...
        cta: { label: "Get Your Free Earnings Estimate", url: `${SITE}/en/owners` },
      },
    },
    faq_group_key: "",
  };
