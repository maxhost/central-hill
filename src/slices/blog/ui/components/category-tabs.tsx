...
/**
 * Category filter (design-system.md → Nav/tabs). Cards are server-rendered and
 * passed in as `items`; filtering is purely client-side over already-rendered
 * nodes — no request-time DB, stays static + fast.
 */
